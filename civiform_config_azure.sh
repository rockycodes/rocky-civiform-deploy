...
export ACCEPT_TRAFFIC_ON_4433=false
...
export SENDER_EMAIL_ADDRESS="rocky.fine@exygy.com"
...
export STAGING_PROGRAM_ADMIN_NOTIFICATION_MAILING_LIST="rocky.fine@exygy.com"

# REQUIRED
# The email address that receives a notifications email each time an applicant
# submits an application to a program in the staging environments, instead of
# sending it to the trusted intermediary's email, as would happen in prod.
export STAGING_TI_NOTIFICATION_MAILING_LIST="rocky.fine@exygy.com"

# REQUIRED
# The email address that receives a notifications email each time an applicant
# submits an application to a program in the staging environments, instead of
# sending it to the applicant's email, as would happen in prod.
export STAGING_APPLICANT_NOTIFICATION_MAILING_LIST="rocky.fine@exygy.com"

# REQUIRED
# The domain name for this CiviForm deployment, including the protocol. 
# E.g. "https://civiform.seattle.gov"
# want this to match what a civic entity my use... just used in JS we think
export BASE_URL="https://rfine-dev.civiform.dev"
...
export STAGING_HOSTNAME="rfine-dev.civiform.dev"
...
export AZURE_LOG_STORAGE_ACCOUNT_NAME="rfine"
...
export APP_PREFIX="rfine-dev-2" # max 19 chars, only numbers, letters, dashes, and underscores
...
export SSL_CERTIFICATE_ARN="arn:aws:acm:us-east-1:423872842560:certificate/eba41778-00a5-487f-9517-da031c7d2039"
...
# Feature or other flags that controls app functionality
########################################################
export FEATURE_FLAG_REPORTING_ENABLED=true
...
export BYPASS_LOGIN_LANGUAGE_SCREENS=true

# # Feature flags and controls for Esri service
...
export ESRI_EXTERNAL_CALL_TRIES=3

export CIVIFORM_SUPPORTED_LANGUAGES="en-US, es-US, am, zh-TW"
